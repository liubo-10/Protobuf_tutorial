...
class PeopleInfoDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<PeopleInfo>
      _instance;
} _PeopleInfo_default_instance_;
}  // namespace contacts
namespace protobuf_people_5finfo_2eproto {
static void InitDefaultsPeopleInfo() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_PeopleInfo =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsPeopleInfo}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_PeopleInfo.base);
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::contacts::PeopleInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::contacts::PeopleInfo, name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::contacts::PeopleInfo, age_),
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::contacts::_PeopleInfo_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "people_info.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "people_info.proto", &protobuf_RegisterTypes);
}
...
PeopleInfo::PeopleInfo()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_people_5finfo_2eproto::scc_info_PeopleInfo.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* PeopleInfo::descriptor() {
  ::protobuf_people_5finfo_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_people_5finfo_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const PeopleInfo& PeopleInfo::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_people_5finfo_2eproto::scc_info_PeopleInfo.base);
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:contacts.PeopleInfo)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:contacts.PeopleInfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:contacts.PeopleInfo)
  return false;
#undef DO_
}
...
void PeopleInfo::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:contacts.PeopleInfo)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:contacts.PeopleInfo)
}

::google::protobuf::uint8* PeopleInfo::InternalSerializeWithCachedSizesToArray(
...
// @@protoc_insertion_point(generalized_merge_from_start:contacts.PeopleInfo)
  ...
  const PeopleInfo* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const PeopleInfo>(
          &from);
  if (source == NULL) {
...
::google::protobuf::Metadata PeopleInfo::GetMetadata() const {
  protobuf_people_5finfo_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_people_5finfo_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::contacts::PeopleInfo* Arena::CreateMaybeMessage< ::contacts::PeopleInfo >(Arena* arena) {
