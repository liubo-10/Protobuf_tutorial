...
static void InitDefaultsscc_info_PeopleInfo_people_5finfo_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_PeopleInfo_people_5finfo_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_PeopleInfo_people_5finfo_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_people_5finfo_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_people_5finfo_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_people_5finfo_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_people_5finfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::contacts::PeopleInfo, age1_),
};
...
const char descriptor_table_protodef_people_5finfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021people_info.proto\022\010contacts\"\'\n\nPeopleI"
  "nfo\022\013\n\003age\030\001 \001(\005\022\014\n\004age1\030\002 \003(\005b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_people_5finfo_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_people_5finfo_2eproto_sccs[1] = {
  &scc_info_PeopleInfo_people_5finfo_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_people_5finfo_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_people_5finfo_2eproto = {
  false, false, descriptor_table_protodef_people_5finfo_2eproto, "people_info.proto", 78,
  &descriptor_table_people_5finfo_2eproto_once, descriptor_table_people_5finfo_2eproto_sccs, descriptor_table_people_5finfo_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_people_5finfo_2eproto::offsets,
  file_level_metadata_people_5finfo_2eproto, 1, file_level_enum_descriptors_people_5finfo_2eproto, file_level_service_descriptors_people_5finfo_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_people_5finfo_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_people_5finfo_2eproto)), true);
namespace contacts {
...
const PeopleInfo& PeopleInfo::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_PeopleInfo_people_5finfo_2eproto.base);
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        ...
        continue;
      // repeated int32 age1 = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedInt32Parser(_internal_mutable_age1(), ptr, ctx);
          CHK_(ptr);
        } else if (static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16) {
          _internal_add_age1(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* PeopleInfo::_InternalSerialize(
  ...
  // repeated int32 age1 = 2;
  {
    int byte_size = _age1_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
          2, _internal_age1(), byte_size, target);
    }
  }
...
// @@protoc_insertion_point(message_byte_size_start:contacts.PeopleInfo)
  ...
  // repeated int32 age1 = 2;
  {
    ...
    _age1_cached_byte_size_.store(cached_size,
...
void PeopleInfo::InternalSwap(PeopleInfo* other) {
  ...
  age1_.InternalSwap(&other->age1_);
