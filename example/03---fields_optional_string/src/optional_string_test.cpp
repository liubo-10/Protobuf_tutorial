...
int main()
{
    ...
    cout << "opt_sting_pt_rl: " << *opt_sting_pt_rl << endl;
    cout << "imp_sting_pt_rl: " << *imp_sting_pt_rl << endl;
    cout << "opt_sting_pt_mu: " << *opt_sting_pt << endl; // 不为空
    cout << "imp_sting_pt_mu: " << *imp_sting_pt << endl; // 不为空
    ...
    cout << "opt_sting_pt_rl: " << *opt_sting_pt_rl << endl;
    cout << "imp_sting_pt_rl: " << *imp_sting_pt_rl << endl;
    cout << "opt_sting_pt_mu: " << *opt_sting_pt << endl; // 
    cout << "imp_sting_pt_mu: " << *imp_sting_pt << endl; // 
    cout << "opt_string: " << test_string.opt_string() << endl; // 
    cout << "imp_string: " << test_string.imp_string() << endl; // 
    cout << "has_opt_string: " << test_string.has_opt_string() << endl; // 为1
